:project-name: miq-RedHat-OpenStack
:project-repo: https://github.com/rhtconsulting/miq-RedHat-OpenStack
:project-zip: https://github.com/rhtconsulting/miq-RedHat-OpenStack/archive/master.zip
